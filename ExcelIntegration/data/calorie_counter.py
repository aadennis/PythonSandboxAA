...
data = {
    "Food Item": [
        ...
        "Homemade Vegetable Soup", "Full-Fat Milk", "Peas"
    ],
    "Calories (kcal)": [
        32, 89, 59, 52, 17, 25, 50, 174, 102, 56, 64, 100, 64, 81
    ],
    "Amount": [
        100, 100, 100, 1, 1, 50, 100, 1, 1, 1, 1, 1, 200, 100
    ],
    "Unit": [
        "g", "g", "g", "tbsp", "tsp", "ml", "ml", "slice", "tbsp", "tbsp", "tbsp", "bowl", "ml", "g"
    ]
}
...
# Save to Excel
output_file = "updated_calorie_table.xlsx"
