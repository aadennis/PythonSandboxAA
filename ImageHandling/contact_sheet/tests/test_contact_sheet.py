...
class TestContactSheet(object): 
    img_folder = "test/TestImageFiles"
       
    def test_small_volume_set1(self):
        # arrange
        output_file = "c:/temp/smallstuff.jpg"
        # act
        contact_sheet = contact_sheet.make_contact_sheet(self.img_folder, output_file)
    ...
    def test_large_volume_set1(self):
        ...
        # act
        contact_sheet = contact_sheet.make_contact_sheet(img_folder, output_file, max_images= max_images, column_count = 10)
